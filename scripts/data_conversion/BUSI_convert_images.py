...
def main() -> None:
    ...
    for index, (image_path, _mask_paths) in enumerate(cases):
        destination = OUTPUT_DIR / f"case{index:03d}_0000.png"
        with Image.open(image_path) as image:
            image.resize((256, 256), resample=Image.Resampling.BILINEAR).save(destination)
